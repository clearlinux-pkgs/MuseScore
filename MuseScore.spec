...
Version  : 3.2.3
Release  : 6
URL      : https://github.com/musescore/MuseScore/archive/v3.2.3/MuseScore-3.2.3.tar.gz
Source0  : https://github.com/musescore/MuseScore/archive/v3.2.3/MuseScore-3.2.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562602971
mkdir -p clr-build
pushd clr-build
...
/usr/share/mscore-3.2/sound/MuseScore_General_License.md
