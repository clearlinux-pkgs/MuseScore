...
Version  : 3.2.1
Release  : 4
URL      : https://github.com/musescore/MuseScore/archive/v3.2.1/MuseScore-3.2.1.tar.gz
Source0  : https://github.com/musescore/MuseScore/archive/v3.2.1/MuseScore-3.2.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1561756167
mkdir -p clr-build
pushd clr-build
